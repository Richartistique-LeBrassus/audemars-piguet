...
const Accessories = () => {
  return (
    <div className="relative h-fit bg-black w-screen py-20
      px-6 md:px-8 lg:px-[97px]"
    >
      <div className="z-10 flex items-end justify-start w-full drop-shadow-2xl
        h-[80%] text-center pb-[20px] 
        md:pb-20 lg:pb-12 lg:items-center lg:top-20
        2xl:pb-12"
      >
        <div className="space-y-2 text-left
          ...
          {/*<button className="pl-[3px] py-4 text-white font-semibold text-[19px]">
            --------  See Them In Person
          </button>*/}
          <div className="group flex flex-row items-center w-fit cursor-pointer">
            ...
            ></span>
            <p className="pl-3 py-4 text-white font-semibold text-[19px]">
              See Them In Person
            </p>
          </div>
        </div>
