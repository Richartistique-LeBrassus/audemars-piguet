...
const QuoteBanner = () => {
  return (
    <div className="relative w-full h-fit bg-teal-950 px-17 pb-[49px]
      md:px-24 md:pb-20 md:pt-6"
    >
      <div className="flex flex-col items-start gap-1 lg:w-[65%] lg:items-center">
