      ...
      >
        {links.map((link, idx) => (
          ...
          >
            <Link
              href={link.href}
              className="hover:block transition-color duration-300 hover:text-neutral-600"
            >
              {link.label}
            </Link>
          </li>
...
const Footer = () => {
  return (
    <footer className="bg-neutral-900 text-white px-6 md:px-8 lg:px-[97px] py-12">
      ...
      <div className="inline-flex w-fit items-center mx-auto gap-3
      ...
      >
        ...
        >
          <FaInstagram size={23} className="hover:cursor-pointer hover:text-neutral-600 transition-colors duration-300" />
          <FaFacebookF size={23} className="hover:cursor-pointer hover:text-neutral-600 transition-colors duration-300" />
          <FaYoutube size={23} className="hover:cursor-pointer hover:text-neutral-600 transition-colors duration-300" />
          <FaTiktok size={23} className="hover:cursor-pointer hover:text-neutral-600 transition-colors duration-300" />
          <FaLinkedinIn size={23} className="hover:cursor-pointer hover:text-neutral-600 transition-colors duration-300" />
        </div>

        <div className="text-neutral-200 flex justify-between max-w-screen-lg mx-auto w-full
          lg:max-w-fit lg:gap-7"
        >  
          <FaPinterestP size={23} className="hover:cursor-pointer hover:text-neutral-600 transition-colors duration-300" />
          <FaWeibo size={23} className="hover:cursor-pointer hover:text-neutral-600 transition-colors duration-300" />
          <FaWeixin size={23} className="hover:cursor-pointer hover:text-neutral-600 transition-colors duration-300" />
          <FaLine size={23} className="hover:cursor-pointer hover:text-neutral-600 transition-colors duration-300" />
          <FaXTwitter size={23} className="hover:cursor-pointer hover:text-neutral-600 transition-colors duration-300" />
        </div>
      </div>
      ...
      <div className="text-neutral-200 border-t border-white/20 mt-14 
        ...
        <p className="mb-2">
          <Link href="#" className="hover:cursor-pointer hover:text-neutral-400 transition-colors duration-300">
            Terms of Use
          </Link>{" "}
          -{" "}
          <Link href="#" className="hover:cursor-pointer hover:text-neutral-400 transition-colors duration-300">
        ...
        <p>© {new Date().getFullYear()} Non-commercial replica for portfolio use only. All rights to original brands and media remain with their owners.</p>
      </div>
    </footer>
  )
}
