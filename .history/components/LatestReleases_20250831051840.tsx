...
import CollectionsRow from "./ui/CollectionsRow";
...
const LatestReleases = () => {
  ...
  return (
    <div className="relative min-h-screen w-screen bg-black py-27
      ...
      <div className="flex gap-[10px] overflow-x-auto snap-x snap-mandatory scrollbar-hide
        lg:-mr-[97px] 2xl:-ml-96"
      >
        {/* className="flex gap-[10px] overflow-x-auto snap-x snap-mandatory scrollbar-hide
        lg:-mr-[97px] 2xl:-ml-96" */}
        <CollectionsRow items={releases} />
      </div>
    </div>
  )
}
