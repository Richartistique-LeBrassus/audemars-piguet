      ...
      >
        {links.map((link, idx) => (
          ...
          >
            <Link
              href={link.href}
              className="hover:block transition-color duration-300 hover:text-teal-500"
            >
              {link.label}
            </Link>
          </li>
...
const Footer = () => {
  return (
    <footer className="bg-teal-900 text-white px-6 md:px-8 lg:px-[97px] py-12">
      ...
      <div className="border-t border-white/20 mt-14 lg:mt-16 2xl:mt-20 pt-6 text-xs text-center">
        <p className="mb-2">
