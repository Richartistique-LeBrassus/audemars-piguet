...
const Footer = () => {
  return (
    <footer className="bg-teal-900 text-white px-6 md:px-8 lg:px-[97px] py-12">
      ...
      >
        <Globe size={24} className="hover:cursor-pointer hover:text-teal-500 transition-colors duration-300" /> 
        <p className="text-lg pt-[2px] font-semibold hover:cursor-pointer hover:text-teal-500 
