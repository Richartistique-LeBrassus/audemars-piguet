    ...
    <div className="relative w-full">
      ...
      <button
        ...
        className="hidden md:flex items-center justify-center absolute left-0 
          ...
          w-12 h-12 bg-black/30 rounded-full 
          border-white/50 border-2
          shadow hover:bg-black/80 transition"
      >
        <ChevronLeft className="w-6 h-6 text-white hover:cursor-pointer" />
      </button>
      ...
      <button
        ...
        className="hidden md:flex items-center justify-center absolute right-0 
          ...
          shadow hover:bg-black/80 transition"
      >
        <ChevronRight className="w-6 h-6 text-white hover:cursor-pointer" />
      </button>
    </div>
  );
}
