  ...
  return (
    <>
      <div className="grid grid-cols-1 2xl:grid-cols-2 min-h-fit gap-2 2xl:gap-0">
        {/*<div className="relative w-full h-[14.5rem] overflow-clip
          2xl:h-[75vh]">*/}
          <div className="relative w-full h-[14.5rem] overflow-clip
          2xl:h-[75vh]">
          <Image
          ...
          >        
            <div className="flex flex-col gap-2">
              <div className="row-start-1 row-end-4 overflow-hidden h-[100%] w-[100%]">
                <Image
              ...
              <div className="row-start-5 row-end-6 overflow-hidden h-[100%] w-[100%]">
                <Image
            ...
            <div className="flex flex-col gap-2">
              <div className="row-span-1 overflow-hidden h-[100%] w-[100%]">
                <Image
              ...
              <div className="row-start-2 row-end-6 overflow-hidden h-[100%] w-[100%]">
                <Image
