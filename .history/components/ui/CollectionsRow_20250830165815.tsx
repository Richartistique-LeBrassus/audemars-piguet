    ...
    <div className="relative w-full">
      ...
      <button
        ...
        className="hidden md:flex items-center justify-center absolute left-0 
                   ...
                   w-12 h-12 bg-white/80 rounded-full shadow hover:bg-white transition"
      >
      ...
      <button
        ...
        className="hidden md:flex items-center justify-center absolute right-0 
          top-1/5 -translate-y-1/2 w-12 h-12 bg-black/30 rounded-full 
          border-white/50 border-2 hover:cursor-pointer
          shadow hover:bg-black/80 transition"
      >
