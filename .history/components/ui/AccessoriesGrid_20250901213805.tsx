...
const AvantGrid = () => {
  return (
    <>
      <div className="min-h-fit relative grid grid-cols-1 2xl:grid-cols-2 gap-2 2xl:gap-0
        px-5 md:px-28"
      >
...
">
          <Image
            ...
            brightness-110 transition duration-500 hover:scale-105"
          />
        </div>
          <div 
            className="grid grid-cols-2 h-fit gap-2 lg:px-3
            w-full"
          >        
