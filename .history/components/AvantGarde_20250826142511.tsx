...
const AvantGarde = () => {
  return (
    <div className="min-h-screen w-full bg-black px-11 md:px-16 lg:px-44 py-[3.3rem]">
      <div className="flex flex-col pt-[64px] pb-22 px-auto">
        <div className="space-y-2 text-left md:grid md:grid-cols-2
        md:w-full md:gap-12 lg:gap-2">
          <div>
            <h2 className="text-[51px] uppercase leading-10
            mb-7 md:mb-9 md:text-[55px] md:leading-12
      ...
      <div 
        className="grid grid-cols-2 grid-rows-6 gap-[9px]
