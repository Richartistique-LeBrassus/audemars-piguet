...
const SearchWatches = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-neutral-100 text-black
      py-12 lg:py-32 px-6 md:px-8 lg:px-[135px]"
    >
      <div className="relative mx-auto md:mx-0">
        <input
          ...
          md:placeholder:text-5xl md:pt-4 2xl:pb-8
          2xl:placeholder:text-6xl"
        />
        <div className="absolute right-0 top-1/3 -translate-y-1/2 text-black"
        >
          <Search size={22} className="md:h-9 md:w-9 2xl:h-14 2xl:w-14" />
        </div>
      </div>  
      ...
      <div className="w-full flex justify-between my-24">
        ...
        <div className="text-black inline-flex">
          <p className="pr-5 font-bold text-xl invisible lg:visible">Compare</p>
      ...
      <div className="flex flex-col w-full">
        <div>
          <h2 className="uppercase text-[29px] mb-3 lg:text-[40px]">Royal Oak</h2>
        </div>
