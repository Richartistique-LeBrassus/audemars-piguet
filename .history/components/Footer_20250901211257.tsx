  ...
  return (
    <footer className="bg-teal-900 text-white px-6 md:px-8 lg:px-[97px] py-12">
      ...
      >
        ...
        >
          <FaInstagram size={23} className="hover:cursor-pointer hover:text-teal-500 transition-colors duration-300" />
          <FaFacebookF size={23} className="hover:cursor-pointer hover:text-teal-500 transition-colors duration-300" />
          <FaYoutube size={23} className="hover:cursor-pointer hover:text-teal-500 transition-colors duration-300" />
          <FaTiktok size={23} className="hover:cursor-pointer hover:text-teal-500 transition-colors duration-300" />
          <FaLinkedinIn size={23} className="hover:cursor-pointer hover:text-teal-500 transition-colors duration-300" />
        </div>

        <div className="text-neutral-200 flex justify-between max-w-screen-lg mx-auto w-full
          lg:max-w-fit lg:gap-7"
        >  
          <FaPinterestP size={23} className="hover:cursor-pointer hover:text-teal-500 transition-colors duration-300" />
          <FaWeibo size={23} className="hover:cursor-pointer hover:text-teal-500 transition-colors duration-300" />
          <FaWeixin size={23} className="hover:cursor-pointer hover:text-teal-500 transition-colors duration-300" />
          <FaLine size={23} className="hover:cursor-pointer hover:text-teal-500 transition-colors duration-300" />
          <FaXTwitter size={23} className="hover:cursor-pointer hover:text-teal-500 transition-colors duration-300" />
        </div>
      </div>
