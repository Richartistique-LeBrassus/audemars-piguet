...
const FooterSection = ({
  ...
  return (
    <div>
      {/* Heading with toggle button (mobile only) */}
      <button
      ...
      <ul
        className={`overflow-hidden transition-all duration-500 ease-in-out space-y-2 
          ...
          lg:max-h-none lg:opacity-100 lg:translate-y-0 lg:block`}
      >
        {links.map((link, idx) => (
          <li
            key={idx}
...
const Footer = () => {
  return (
    ...
    <footer className="bg-black text-white px-6 md:px-8 lg:px-[97px] py-12">
