...
const AvantGarde = () => {
  return (
    <div className="min-h-screen w-full bg-black px-11 md:px-16 lg:px-[188px] lg:py-[90px] py-[3.3rem]">
      <div className="flex flex-col pt-[64px] pb-22 w-full justify-between">
