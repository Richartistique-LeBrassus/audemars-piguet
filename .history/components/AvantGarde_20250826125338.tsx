...
const AvantGarde = () => {
  return (
    <div className="min-h-screen w-full bg-black px-11 py-[3.3rem]">
      ...
      <div className="grid grid-cols-2 grid-rows-6 gap-[var(--lookbook-self-base-default-gap)] w-full aspect-[1/2]">
        <div className="relative row-start-1 row-end-3 col-start-1 col-end-2">
          <video 
