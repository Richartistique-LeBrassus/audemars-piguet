...
const SearchWatches = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-neutral-50 text-black
      py-12 px-6 md:px-8"
    >
      <div className="relative mx-auto md:mx-0 md:mt-10">
        <input
          type="text"
          ...
          md:placeholder:text-4xl md:pb-1"
        />
        <div className="absolute right-0 top-1/3 -translate-y-1/2 text-black"
        >
          <Search size={22} className="md:h-9 md:w-9" />
        </div>
      </div>  
      ...
      <div className="flex flex-col w-full">
        <div>
          <h2 className="uppercase text-[29px] mb-3 mdp:text-6xl">Royal Oak</h2>
        </div>
