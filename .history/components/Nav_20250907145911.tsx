      ...
      <div className="px-auto flex items-center justify-between w-full">
        <div className="flex items-center justify-between gap-3 max-w-fit">
          ...
          <div className="relative w-[18px] h-[18px]">
            {/* Burger */}
            <div
              className="absolute inset-0 flex flex-col justify-between mt-1 w-full h-2 lg:h-2.5"
            >
            ...
            <div
              className="absolute inset-0 lg:flex lg:flex-col lg:justify-between 
              mt-1 w-full h-2 lg:h-2.5 text-white capitalize text-base
              hidden"
            >
              <span
                className=""
