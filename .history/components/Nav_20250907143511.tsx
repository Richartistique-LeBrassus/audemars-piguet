...
const Nav = () => {
  return (
    ...
    font-semibold px-5 md:px-9 md:py-11 py-[24px]  lg:px-20
    ">
      <div className="px-auto flex items-center justify-between w-full">
        <div className="flex items-center justify-between gap-3 max-w-fit">
          ...
          <div className="relative w-[18px] h-[18px]">
            {/* Burger */}
            <div
              className="absolute inset-0 flex flex-col justify-between mt-1 md:mt-2 w-full h-2"
            >
        ...
        <div className="flex items-center justify-between gap-3 max-w-fit">
          ...
          <div className="h-fit w-fit">
            <Watch className="w-8 h-8 text-neutral-50 hidden md:block" />
          </div> 
