...
const BleuNuit: React.FC = () => {
  return (
    <section className="relative w-full h-screen text-white px-5">
      <div className="absolute inset-0">
        <Image
          src="/imgs/darkblue.jpg" 
          alt="Hero Image"
          layout="fill"
          objectFit="cover"
          priority
      ...
      <div className="relative z-10 flex items-end justify-end w-full h-full text-center pb-[27px]">
